...
\NormalTok{pacman}\OperatorTok{::}\KeywordTok{p_load}\NormalTok{(tidyverse, broom, haven, plm, lmtest)}
...
\section{\texorpdfstring{Einführung: \emph{random effects} Modelle für Paneldaten}{Einführung: random effects Modelle für Paneldaten}}\label{einfuxfchrung-random-effects-modelle-fuxfcr-paneldaten}}
...
\item
  ...
  \end{itemize}
\item
  Das \emph{random effects} Modell wird geschätzt als
...
\hypertarget{advantages-of-the-re-model}{%
\section{Advantages of the RE model}\label{advantages-of-the-re-model}}
...
\hypertarget{is-the-re-model-ever-justified}{%
\section{Is the RE model ever justified?}\label{is-the-re-model-ever-justified}}
...
measure (like income or church attendance) is implausible." --- \citet{vaiseyWhatYouCan2017}, p.~47
