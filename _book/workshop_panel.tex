...
## -1.1811 -0.2609  0.1079  0.4811  0.7554 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   0.4686     0.2344   1.999   0.0806 .
## x             0.1677     0.4765   0.352   0.7340  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6859 on 8 degrees of freedom
## Multiple R-squared:  0.01524,    Adjusted R-squared:  -0.1079 
## F-statistic: 0.1238 on 1 and 8 DF,  p-value: 0.734
\end{verbatim}
