...
* Für das Null-Modell können wir die ICC ausweisen. Da im Modell auch *fixed effects* sind, interpretieren wir den *conditional ICC*. Mehr als die Hälfte der Varianz in der Intention, ohne triftigen Grund die Wohnung zu verlassen, liegt zwischen den Personen.
